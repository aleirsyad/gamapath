...
class NextQuestionButtonPressed extends QuizEvent{
  final String praticesId;
  final int sub;
  final String answer;
  final String number;
...
class PreviousQuestionButtonPressed extends QuizEvent{
  final String praticesId;
  final int amount;
  // final String answer;
...
class LastQuestionButtonPressed extends QuizEvent{
  final String praticesId;
  // final String answer;
  final String answer;
  final String number;
