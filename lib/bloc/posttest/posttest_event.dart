...
abstract class PosttestEvent extends Equatable{
  const PosttestEvent();
}

class GetQuestion extends PosttestEvent{
...
class NextQuestionButtonPressed extends PosttestEvent{
  final String praticesId;
  final int sub;
  final String answer;
  final String number;
...
class PreviousQuestionButtonPressed extends PosttestEvent{
  final String praticesId;
  final int amount;
  // final String answer;
...
class LastQuestionButtonPressed extends PosttestEvent{
  final String praticesId;
  // final String answer;
  final String answer;
  final String number;
