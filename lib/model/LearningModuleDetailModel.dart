...
class LearningModuleDetailModel {
  ...
  bool success;
  int code;
  LearningModuleDetail data;

  factory LearningModuleDetailModel.fromJson(Map<String, dynamic> json) => LearningModuleDetailModel(message: json["message"], success: json["success"], code: json["code"], data: LearningModuleDetail.fromJson(json["data"]));
...
class LearningModuleDetail{
  ...
  String myQuizResult;
    ...
    factory LearningModuleDetail.fromJson(Map<String, dynamic> json) => LearningModuleDetail(id: json["id"], teacherId:json["teacher_id"], name: json["name"], createdAt: json["created_at"], updatedAt: json["updated_at"], categoryId: json["category_id"], teacher: Teacher.fromJson(json["teacher"]),cases: List<CasesItem>.from(json["cases"].map((x) => CasesItem.fromJson(x))), myQuizResult: json["my_quiz_result"]);
